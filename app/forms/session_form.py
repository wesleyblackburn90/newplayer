...
class SessionForm(FlaskForm):
  ...
  location_name = StringField('Location Name', validators=[DataRequired("Must provide a location"), Length(min=3, max=50, message='Must be between 3 and 50 characters')])
  ...
  city = StringField('City', validators=[DataRequired("Please provide a city"), Length(min=1, max=30, message='City name must be less than 30 characters')])
  ...
  players_num = IntegerField('players_num', validators=[DataRequired("Please choose how many players you need"), NumberRange(min=2, max=2000, message="Please enter a valid number")])
